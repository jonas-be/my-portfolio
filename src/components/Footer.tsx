...
function Footer() {
  return (
    <footer className='p-3 sm:p-6'>
        <div className="accent-background rounded-2xl">
      ...
      <a href='https://discord.gg/EbFsEQbB7J' className='flex flex-row justify-center items-center text font-medium text-lg p-1'>
