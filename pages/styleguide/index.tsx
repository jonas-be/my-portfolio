        ...
        <>
            ...
            <div className="flex flex-col md:flex-row justify-center m-2 py-6 gap-16 lg:gap-40">
                <div className="grid grid-cols-3  justify-items-center gap-6">
                    <div className="w-28 h-28 rounded-2xl bg-primary text-white font-semibold text-sm flex justify-center items-center"><span>bg-primary</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-secondary text-white font-semibold text-sm flex justify-center items-center"><span>bg-secondary</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-info text-white font-semibold text-sm flex justify-center items-center"><span>bg-info</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-success text-white font-semibold text-sm flex justify-center items-center"><span>bg-success</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-warning text-white font-semibold text-sm flex justify-center items-center"><span>bg-warning</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-error text-white font-semibold text-sm flex justify-center items-center"><span>bg-error</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-reverse text-accent-reverse font-semibold text-sm flex justify-center items-center"><span>bg-reverse</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-accent text font-semibold text-sm flex justify-center items-center"><span>bg-accent</span></div>
                    <div className="w-28 h-28 rounded-2xl bg-accent-2 text font-semibold text-sm flex justify-center items-center"><span>bg-accent-2</span></div>
                </div>
            ...
            <div className="w-full flex justify-around">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <Link href="/styleguide/buttons" className="btn border-warning text-warning btn-bordered">Button</Link>
